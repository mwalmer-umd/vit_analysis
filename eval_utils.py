"""
###########################################################################
This evaluation utility code includes code from 
https://github.com/facebookresearch/dino. Original copyright
notice shown below:

Misc functions. Mostly copy-paste from torchvision references or other
public repos like DETR:
...
from PIL import ImageFilter, ImageOps, ImageFile, Image
